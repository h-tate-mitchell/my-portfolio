...
export const resume:Resume = {
    ...
    title: "Web Developer",
    proSummary: "Detail-oriented Web Developer who specializes in analytics development, programming, and third-party app integration. Improved performance for 300+ client websites, enhanced SEO, and increased user engagement. Collaborated with cross-functional teams to deliver data-driven solutions. Seeking to contribute expertise to a dynamic web development team.",
    skills: {
