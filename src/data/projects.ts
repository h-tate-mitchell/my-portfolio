...
export const projects:Project[] = [
    {
        ...
        challenge : "The goal of this project was to create a REPL script to automate the process of updating and pruning the internal and outgoing redirects list based on certain criteria. Our redirect cleaning process includes removing duplicate identical entries, removing infinite or reflexive redirects, shortening redirect chains to their smallest form, and removing any redirects with improper types. The types of redirects we dealt with were path, exact URLs, and regular expressions (regex).",
        approach : "The project started by setting up a Mongo query to the client database to retrieve redirect data. Once the data was received, the processing began.",
